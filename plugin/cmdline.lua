...
vim.api.nvim_create_autocmd({ 'CmdlineChanged', 'CmdlineLeave' }, {
    ...
    callback = function(ev)
        local function should_enable_autocomplete()
            ...
            return cmdline_type == '/' or cmdline_type == '?' or (cmdline_type == ':' and (is_cmdline_type_find() or cmdline_cmd == 'help' or cmdline_cmd == 'h' or cmdline_cmd == 'buffer' or cmdline_cmd == 'b'))
        end
...
vim.keymap.set('c', '<c-space>', '<home><s-right><c-w>EditWindowFloat<end>', { desc = 'Change command to :EditWindowFloat' })
