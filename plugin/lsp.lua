...
vim.api.nvim_create_autocmd("LspAttach", {
    callback = function(args)
        ...
        if Snacks then
            vim.keymap.set('n', 'grr', function() Snacks.picker.lsp_references({ layout = 'dropdown' }) end,
            ...
            vim.keymap.set('n', 'gri', function() Snacks.picker.lsp_implementations({ layout = 'dropdown' }) end,
                { desc = '[LSP] Go to implementation' })
            vim.keymap.set('n', 'grt', function() Snacks.picker.lsp_type_definitions({ layout = 'dropdown' }) end,
                { desc = '[LSP] Go to type definition' })
            vim.keymap.set('n', 'gO', function() Snacks.picker.lsp_symbols({ layout = 'dropdown' }) end,
                { desc = '[LSP] Search document symbols' })
            vim.keymap.set('n', 'g<c-o>', function() Snacks.picker.lsp_workspace_symbols({ layout = 'dropdown' }) end,
                { desc = '[LSP] Search workspace symbols' })
        else
